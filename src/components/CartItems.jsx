        ...
        if (cartItems[e.id] > 0) {
          return (
            <div key={e.id} className="w-full">
              <div className="w-full grid grid-cols-6 h-20 overflow-hidden border-b-2 border-black">
                <div className="w-full flex items-center justify-center">
                  <img src={e.image} alt="producticon" className="w-auto h-14 text-center" />

                </div>
                <p className="w-full flex items-center justify-center ">{e.name}</p>
                <p className="w-full flex items-center justify-center ">{e.new_price}</p>
                <button className="w-full flex items-center justify-center  ">{cartItems[e.id]}</button>
                <p className=" w-full flex items-center justify-center">{e.new_price * cartItems[e.id]}</p>
                <div className="w-full flex items-center justify-center">
